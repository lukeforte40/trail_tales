...
export default function TripTile({tripKey,id, title, contentStart, contentClick, activeId, open, close}){
    return(
        <div key={tripKey} onClick={open} className={styles.tripContainer} id={id}>
